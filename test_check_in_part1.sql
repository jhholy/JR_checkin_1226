...
BEGIN
  -- 检查JR教练是否存在
  IF NOT EXISTS (SELECT 1 FROM trainers WHERE id = '99999999-8888-7777-6666-555555555555') THEN
    INSERT INTO trainers (id, name, type)
    VALUES ('99999999-8888-7777-6666-555555555555', 'JR', 'jr');
  END IF;
  
  -- 检查Da教练是否存在
  IF NOT EXISTS (SELECT 1 FROM trainers WHERE id = '88888888-7777-6666-5555-444444444444') THEN
    INSERT INTO trainers (id, name, type)
